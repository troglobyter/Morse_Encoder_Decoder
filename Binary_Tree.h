...
public:
	...
	*/
	...
	Binary_Tree<Item_Type> get_left_subtree();

	/** Return the right subtree. */
	Binary_Tree<Item_Type> get_right_subtree();
...
template<typename Item_Type>
bool Binary_Tree<Item_Type>::insert(BTNode<Item_Type>*& local_root, const Item_Type& item) {
	if (local_root == NULL) {
